...
public class GaussianMixtureDistribution implements RandomDistribution {
     ...
     * Gaussian distributions evently distributed between 0 and 1 with a unitary
     * variance.
     *
     * @param nbGaussians
     *            The number of distributions composing the mixture.
     */
     ...
     * values, variances and proportions of each distribution is given as an
     * argument.
     *
     * @param means
     *            The mean values of the Gaussian distributions.
     * @param variances
     *            The variances of the Gaussian distributions.
     * @param proportions
     *            The mixing proportions. This array does not have to be
     *            normalized, but each element must be positive and the sum of
     *            its elements must be strictly positive.
     */
    ...
    /**
     * Returns the proportions of the distributions in this mixture. The sum of
     * the proportions equals 1.
     *
