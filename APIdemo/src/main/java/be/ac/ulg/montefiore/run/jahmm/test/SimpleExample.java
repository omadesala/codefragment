...
public class SimpleExample {
    ...
    static public void main(String[] argv) throws java.io.IOException {
        ...
        List<List<ObservationDiscrete<Packet>>> sequences = generateSequences(hmm);
    ...
    static Hmm<ObservationDiscrete<Packet>> buildHmm() {
        Hmm<ObservationDiscrete<Packet>> hmm = new Hmm<ObservationDiscrete<Packet>>(2, new OpdfDiscreteFactory<Packet>(
                Packet.class));
