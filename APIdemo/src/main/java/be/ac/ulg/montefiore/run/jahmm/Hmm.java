...
public class Hmm<O extends Observation> implements Serializable, Cloneable {
     ...
     * @param opdfFactory
     *            A pdf generator that is used to build the pdfs associated to
     *            each state.
     */
     ...
     *
     * @param pi
     *            The initial probability values. <code>pi[i]</code> is the
     *            initial probability of state <code>i</code>. This array is
     *            copied.
     * @param a
     *            The state transition probability array. <code>a[i][j]</code>
     *            is the probability of going from state <code>i</code> to state
     *            <code>j</code>. This array is copied.
     * @param opdfs
     *            The observation distributions. <code>opdfs.get(i)</code> is
     *            the observation distribution associated with state
