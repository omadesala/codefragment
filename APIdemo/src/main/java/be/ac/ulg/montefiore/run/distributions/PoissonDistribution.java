...
public class PoissonDistribution implements DiscreteDistribution {
    ...
    private static final double[] logFactTable = { 0.00000000000000000, 0.00000000000000000, 0.69314718055994531,
     ...
     *
     * @param mean
     *            The mean duration between two consecutive events.
     */
    ...
    private double logFactorial(int n) {
        if (n >= logFactTable.length) {
            ...
            return (n + .5) * Math.log(n) - n + C0 + r * (C1 + r * r * (C3 + r * r * (C5 + r * r * C7)));
        } else
