...
//
//        // 条件过滤集合
//        // 方法来自 com.google.common.collect.Iterables 以及
...
//        GuavaDemo t = new GuavaDemo("Tite", new Date(), "Author");
//
//    }
//
...
//
//    // Multimap的高级应用
//    // listOfMaps代表一个List中包含多个这种 mapOf("type", "blog", "id", "292", "author",
//    // "john"); 类型的Map
...
//
//    // 使用Preconditions进行校验
//    public GuavaDemo(String title, Date date, String author) {
