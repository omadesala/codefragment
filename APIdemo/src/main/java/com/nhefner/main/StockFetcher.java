...
//    private String params = "table.csv?s=600000.SS&a=08&b=25&c=2010&d=09&e=8&f=2012&g=d";
    /*
	...
	*/
    ...
    static String buildUrlWithParams(String name, String interval,
        ...
        sb.append("http://ichart.yahoo.com/table.csv?s=").append(name).append("&");
        sb.append("a=");
    ...
    static List<StockHistory> getStockHistory(String symbol){
...
//        private String symbol;
        ...
        String url = buildUrlWithParams(symbol,D,2012,01,01,2013,01,01);
        ...
        try {
            ...
            while((line = br.readLine())!=null){
                ...
                result.add(new StockHistory(symbol,date,open,high,low,close,volume,adjclose));
