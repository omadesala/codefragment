...
public class ExcelUtils {
    ...
    public static void main(String[] args) {
        ...
        String path = "/home/daniel/demos/chinaclouddemo.xls";

        testExcel.readExcelToObj(path);
    }

    public void testReadExcel(String filePath) {
        ...
        for (int i = startReadLine; i < sheet.getLastRowNum() - tailLine + 1; i++) {
            ...
            for (Cell c : row) {
                ...
                if (isMerge) {
                    ...
                    System.out.print(rs + "  " + "merged");
                } else {
                    System.out.print(c.getRichStringCellValue() + "  no-merge");
                }
            }
            System.out.println();
